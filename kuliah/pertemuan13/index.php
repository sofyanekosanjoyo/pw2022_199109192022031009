...
<body>
  ...
  <form method="post" action="">
    <input type="text" name="kata_kunci" size="40" placeholder="Masukkan kata pencarian" autocomplete="off" autofocus class="kata-kunci">
    <button type="submit" name="tombol-cari" class="tombol-cari">Cari</button>
  </form>
  <br>
